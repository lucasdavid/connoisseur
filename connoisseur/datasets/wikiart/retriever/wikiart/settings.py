...
PAINTING_ATTRIBUTES = (
    'contentId', 'artistUrl',
    # 'image', 'url', 'title', 'description', 'serie', 'style', 'period',
    # 'genre', 'technique', 'material', 'height', 'width', 'sizeX', 'sizeY',
    # 'diameter', 'auction', 'location', 'artistContentId', 'artistName',
    # 'completitionYear', 'yearAsString', 'yearOfTrade', 'galleryName',
    # 'lastPrice'
)
