...
def config():
    ...
    data_dir = '/datasets/vangogh-test-recaptures/recaptures-google-vangogh2016/resized/'
    saving_directory = '/datasets/vangogh-test-recaptures/recaptures-google-vangogh2016/resized/patches/random/'
    valid_size = 0
    train_n_patches = 50
    valid_n_patches = 50
    test_n_patches = 50
