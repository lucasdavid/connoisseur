...
def run(_run, dataset_seed, svm_seed, n_train_samples,
        ...
        train_n_patches, train_augmentations, train_dataset_seed, train_shuffle,
        test_n_patches, test_augmentations, test_dataset_seed, test_shuffle,
