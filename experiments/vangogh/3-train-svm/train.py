...
@ex.config
def config():
    data_dir = '/datasets/ldavid/vangogh/max_gradient_256/inejc/'
    ckpt_file_name = './max-gradient-256-inejc-svm.pkl'
...
def run(data_dir, nb_samples_used, grid_searching,
    ...
    model = Pipeline([
        ...
        ('svc', SVC(class_weight='balanced', random_state=13, max_iter=100000000))
    ])
